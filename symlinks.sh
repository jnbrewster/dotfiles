...
files=" amethyst  bashrc bash_profile config hushlogin muttrc newsbeuter profile tmux.conf vim vimrc vimperatorrc "    # list of files/folders to symlink in homedir
