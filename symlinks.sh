...
files=" amethyst atom bashrc bash_profile config hushlogin newsbeuter profile pentadactylrc qutebrowser tmux.conf vim vimrc xinitrc Xdefaults Xmodmap vimperatorrc "    # list of files/folders to symlink in homedir
