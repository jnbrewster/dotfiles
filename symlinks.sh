...
files=" amethyst  bashrc bash_profile config hushlogin kwm muttrc newsbeuter profile pentadactylrc tmux.conf todo.cfg vim vimrc vimperatorrc "    # list of files/folders to symlink in homedir
