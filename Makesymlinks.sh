...
files=" angband amethyst bash_profile bashrc config hushlogin muttrc nvim nvimrc profile tmux.conf vim vimrc weechat . "    # list of files/folders to symlink in homedir
