...
hi StatusLine           cterm=none ctermbg=8        ctermfg=15      gui=none        guibg=#5D5D5D   guifg=#F6DC69
hi StatusLineNC         cterm=none ctermbg=15       ctermfg=8       gui=none        guibg=#5D5D5D   guifg=#3B3B3B
hi VertSplit            cterm=none ctermbg=15       ctermfg=8       gui=none        guibg=#5D5D5D   guifg=#5D5D5D
